            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="低温报警下限">
                  <el-input-number v-model="thresholds.temperature.min" :min="-20" :max="thresholds.temperature.max - 1" :step="1" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="高温报警上限">
                  <el-input-number v-model="thresholds.temperature.max" :min="thresholds.temperature.min + 1" :max="60" :step="1" />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="低湿报警下限">
                  <el-input-number v-model="thresholds.humidity.min" :min="0" :max="thresholds.humidity.max - 1" :step="5" />
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="高湿报警上限">
                  <el-input-number v-model="thresholds.humidity.max" :min="thresholds.humidity.min + 1" :max="100" :step="5" />
                </el-form-item>
              </el-col>
            </el-row>
...
function getAlarmTypeTag(type) {
  if (type.includes('high') || type.includes('gas')) return 'danger';
  return 'warning';
}
