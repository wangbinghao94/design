...
export default {
  ...
  analysis: {
    ...
    getWeeklyReport(params) {
      return apiClient.get('/api/analysis/weekly-report', { 
        params,
        timeout: 60000 // AI分析耗时较长，单独设置较长的超时时间
      })
    },
    // 异常分析
    getAbnormalityAnalysis(alarmId) {
      return apiClient.post('/api/analysis/abnormality', { alarm_id: alarmId }, {
        timeout: 60000 // AI分析耗时较长
      })
    },
  },
}
